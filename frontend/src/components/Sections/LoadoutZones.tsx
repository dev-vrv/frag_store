            ...
            return (
              ...
              >
                <div className="relative isolate h-full translate-y-0 overflow-hidden rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.025))] p-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.02),0_24px_60px_rgba(0,0,0,0.18)] backdrop-blur-xl transition-[transform,border-color,box-shadow,background-color] duration-500 ease-out will-change-transform group-hover/loadout-card:-translate-y-[3px] group-hover/loadout-card:border-white/14 group-hover/loadout-card:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03),0_30px_70px_rgba(0,0,0,0.28)] sm:rounded-[1.8rem] sm:p-6">
                  ...
                  <div className={cn("pointer-events-none absolute -right-10 top-6 h-32 w-32 rounded-full blur-3xl transition-transform duration-500 ease-out group-hover/loadout-card:translate-x-1 group-hover/loadout-card:scale-105", theme.orb)} />
                  <div className="pointer-events-none absolute -left-6 bottom-10 h-20 w-20 rounded-full bg-white/8 blur-2xl opacity-40 transition-transform duration-500 ease-out group-hover/loadout-card:scale-105" />
                  <div className={cn("pointer-events-none absolute inset-x-6 top-0 h-px bg-gradient-to-r from-transparent to-transparent transition-opacity duration-400 ease-out group-hover/loadout-card:opacity-100", theme.line)} />
                  <div className="pointer-events-none absolute right-6 top-6 h-14 w-14 rounded-full border border-white/10 opacity-40 transition-all duration-500 ease-out group-hover/loadout-card:scale-105 group-hover/loadout-card:opacity-80" />
                  <div className="pointer-events-none absolute left-6 top-24 right-6 h-px origin-left scale-x-0 bg-gradient-to-r from-white/0 via-white/18 to-white/0 transition-transform duration-500 ease-out group-hover/loadout-card:scale-x-100" />
