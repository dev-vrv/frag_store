            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex h-full flex-col">
                  ...
                  <h3 className="font-display mt-6 text-[1.35rem] tracking-[0.03em] text-white transition-colors duration-500 group-hover:text-red-50 sm:mt-8 sm:text-2xl">
                    {card.title}
                  </h3>
                  <p className="mt-3 flex-1 text-sm leading-6 text-zinc-400 transition-colors duration-500 group-hover:text-zinc-300 sm:mt-4 sm:leading-7">
                    {card.description}
                  </p>

                  <div className="mt-5 flex items-center justify-between gap-3 border-t border-white/10 pt-4 transition-colors duration-500 group-hover:border-white/15 sm:mt-6 sm:gap-4 sm:pt-5">
