        ...
        <div className="relative">
          ...
          {open ? (
            <div
              ...
              className="cyber-cut-surface font-tech absolute left-0 top-[calc(100%+0.5rem)] z-40 max-h-72 w-full overflow-y-auto rounded-xl border border-lime-300/30 bg-zinc-950/95 p-2 text-sm uppercase tracking-[0.08em] shadow-[0_0_36px_rgba(190,242,100,0.16)]"
            >
              {options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "cyber-cut-small flex w-full cursor-pointer items-center gap-2 rounded-lg border border-transparent px-3 py-2.5 text-left text-zinc-300 outline-none transition hover:border-lime-300/25 hover:bg-lime-300/10 hover:text-lime-100 disabled:cursor-not-allowed disabled:opacity-45",
