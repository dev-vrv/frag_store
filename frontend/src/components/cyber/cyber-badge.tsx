...
const cyberBadgeVariants = cva(
  "inline-flex w-fit items-center gap-1 rounded-[0.4rem] border px-2.5 py-1 font-mono text-[0.68rem] font-semibold uppercase leading-none tracking-[0.18em]",
  {
    variants: {
      variant: {
        cyan: "border-red-300/40 bg-red-300/10 text-red-100",
    ...
    compoundVariants: [
      { variant: "cyan", glow: true, className: "shadow-[0_0_18px_rgba(248,113,113,0.22)]" },
