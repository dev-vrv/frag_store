...
const cyberButtonVariants = cva(
  "cyber-cut-button font-tech group relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 overflow-hidden whitespace-nowrap border-2 text-sm font-semibold tracking-[0.04em] outline-none [clip-path:polygon(0_0,calc(100%-10px)_0,100%_10px,100%_100%,10px_100%,0_calc(100%-10px))] transition-[clip-path,transform,background-color,border-color,color,box-shadow,filter] duration-300 ease-out before:pointer-events-none before:absolute before:inset-y-0 before:-left-1/2 before:w-1/3 before:-translate-x-full before:-skew-x-12 before:bg-gradient-to-r before:from-transparent before:via-white/25 before:to-transparent before:opacity-0 before:transition-[transform,opacity] before:duration-500 before:ease-out after:pointer-events-none after:absolute after:inset-x-4 after:bottom-0 after:h-px after:origin-center after:scale-x-0 after:bg-current after:opacity-60 after:transition-transform after:duration-300 hover:-translate-y-0.5 hover:[clip-path:polygon(0_0,calc(100%-14px)_0,100%_14px,100%_100%,14px_100%,0_calc(100%-14px))] hover:before:translate-x-[550%] hover:before:opacity-100 hover:after:scale-x-100 active:translate-y-px active:scale-[0.985] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-45 focus-visible:ring-2 focus-visible:ring-lime-300/50 motion-reduce:transition-none motion-reduce:hover:transform-none motion-reduce:before:transition-none motion-reduce:after:transition-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
        ...
        outline:
          "border-lime-300/65 bg-zinc-950/30 text-lime-100 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.03)] hover:border-lime-200 hover:bg-lime-300/10 hover:shadow-[0_0_28px_rgba(190,242,100,0.22)]",
      },
      size: {
